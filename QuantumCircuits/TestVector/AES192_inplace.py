...
def round_combine2(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine3(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine4(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine5(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine6(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine7(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine8(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine9(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine10(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
def round_combine11(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
if __name__ == "__main__":
    ...
    print("round 2")
    round_combine2(2, round1_qubits, key_qubits, round2_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  -1, input_qibuts, -1)
    print("round 3")
    round_combine3(3, round2_qubits, key_qubits, round3_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 1:32 * 1 + 32], round1_qubits, all_q_ancli_for_key_w3[32 * 0:32 * 0 + 32])
    print("round 4")
    round_combine4(4, round3_qubits, key_qubits, round4_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32], round2_qubits, all_q_ancli_for_key_w3[32 * 1:32 * 1 + 32])
    print("round 5")
    round_combine5(5, round4_qubits, key_qubits, round5_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  -1, round3_qubits, -1)
    print("round 6")
    round_combine6(6, round5_qubits, key_qubits, round6_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32], round4_qubits, all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32])
    print("round 7")
    round_combine7(7, round6_qubits, key_qubits, round7_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32], round5_qubits, all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32])
    print("round 8")
    round_combine8(8, round7_qubits, key_qubits, round8_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  -1, round6_qubits, -1)
    print("round 9")
    round_combine9(9, round8_qubits, key_qubits, round9_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 5:32 * 8 + 32], round7_qubits, all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32])
    print("round 10")
    round_combine10(10, round9_qubits, key_qubits, round10_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 6:32 * 6 + 32], round8_qubits, all_q_ancli_for_key_w3[32 * 5:32 * 5 + 32])
    print("round 11")
    round_combine11(11, round10_qubits, key_qubits, round11_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  -1, round9_qubits, -1)
    print("round 12")
