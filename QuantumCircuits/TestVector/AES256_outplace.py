...
def Sbox_combine(eng, u1, u2, s2, q_used, q_zero, q, resource_check):
    ...
    Toffoli_gate(eng, q_used[72], q_used[1], q_used[59], resource_check)
    Toffoli_gate(eng, q_used[71], q_used[2], q_used[58], resource_check)
    Toffoli_gate(eng, q_used[70], q_used[0], q_used[57], resource_check)
    Toffoli_gate(eng, q_used[69], q_used[11], q_used[56], resource_check)
    Toffoli_gate(eng, q_used[68], q_used[4], q_used[55], resource_check)
    Toffoli_gate(eng, q_used[67], u1[7], q_used[54], resource_check)
    Toffoli_gate(eng, q_used[66], u1[4], q_used[53], resource_check)
    Toffoli_gate(eng, q_used[65], q_used[12], q_used[52], resource_check)
    Toffoli_gate(eng, q_used[64], q_used[8], q_used[51], resource_check)
    Toffoli_gate(eng, q_used[37], q_used[7], q_used[50], resource_check)
    Toffoli_gate(eng, q_used[41], u1[5], q_used[49], resource_check)
    Toffoli_gate(eng, q_used[38], u1[6], q_used[48], resource_check)
    Toffoli_gate(eng, q_used[16], q_used[10], q_used[47], resource_check)
    Toffoli_gate(eng, q_used[33], q_used[6], q_used[46], resource_check)
    Toffoli_gate(eng, q_used[39], u1[3], q_used[45], resource_check)
    Toffoli_gate(eng, q_used[21], u1[0], q_used[44], resource_check)
    Toffoli_gate(eng, q_used[36], q_used[5], q_used[43], resource_check)
    Toffoli_gate(eng, q_used[40], q_used[3], q_used[42], resource_check)
    CNOT | (q_used[37], q_used[72])
    CNOT | (q_used[41], q_used[71])
    CNOT | (q_used[38], q_used[70])
    CNOT | (q_used[16], q_used[69])
    ...
    Toffoli_gate(eng, q_used[63], q_used[35], q_used[36], resource_check)
    Toffoli_gate(eng, q_used[62], q_used[32], q_used[33], resource_check)
    Toffoli_gate(eng, q_used[27], q_used[25], q_used[31], resource_check)
    Toffoli_gate(eng, q_used[29], q_used[28], q_used[30], resource_check)
    ...
    CNOT | (q_used[25], q_used[63])
    Toffoli_gate(eng, q_used[16], q_used[60], q_used[35], resource_check)
    Toffoli_gate(eng, q_used[61], q_used[21], q_used[32], resource_check)
    Toffoli_gate(eng, q_used[15], q_used[9], q_used[26], resource_check)
    CNOT | (q_used[9], q_used[61])
    CNOT | (q_used[15], q_used[60])
    ...
    Toffoli_gate(eng, q_used[1], q_used[7], q_used[24], resource_check)
    CNOT | (q_used[22], q_used[23])
    Toffoli_gate(eng, q_used[2], u1[5], q_used[23], resource_check)
    Toffoli_gate(eng, q_used[0], u1[6], q_used[22], resource_check)
    CNOT | (q_used[19], q_used[21])
    Toffoli_gate(eng, q_used[11], q_used[10], q_used[21], resource_check)
    CNOT | (q_used[19], q_used[15])
    Toffoli_gate(eng, q_used[4], q_used[6], q_used[20], resource_check)
    Toffoli_gate(eng, u1[7], u1[3], q_used[19], resource_check)
    CNOT | (q_used[18], q_used[16])
    Toffoli_gate(eng, u1[4], u1[0], q_used[18], resource_check)
    CNOT | (q_used[16], q_used[9])
    Toffoli_gate(eng, q_used[12], q_used[5], q_used[17], resource_check)
    Toffoli_gate(eng, q_used[8], q_used[3], q_used[16], resource_check)
    CNOT | (q_used[0], u1[5])
...
def Sbox_combine_backup(u1, u2, s2, q_used, q_zero, q, resource_check):

    assert len(q_used) == 83
    assert len(q_zero) == 25
    ...
    new_q_used[1] = q_zero[1]
    new_q_used[2] = q_zero[2]
    new_q_used[3] = q_used[82]
    new_q_used[4] = q_zero[3]
    new_q_used[5] = q_zero[4]
    new_q_used[6] = q_zero[5]
    new_q_used[7] = q_zero[6]
    new_q_used[8] = q_zero[7]
    new_q_used[9] = q_zero[8]
    new_q_used[10] = q_zero[9]
    new_q_used[11] = q_zero[10]
    new_q_used[12] = q_zero[11]
    new_q_used[13] = q_zero[12]
    new_q_used[14] = q_used[68]
    new_q_used[15] = q_zero[13]
    new_q_used[16] = q_zero[14]
    new_q_used[17] = q_zero[15]
    new_q_used[18] = q_zero[16]
    new_q_used[20] = q_zero[17]
    new_q_used[21] = q_zero[18]
    new_q_used[22] = q_zero[19]
    new_q_used[24] = q_zero[20]
    new_q_used[25] = q_zero[21]
    new_q_used[27] = q_zero[22]
    new_q_used[19] = q_used[67]
    new_q_used[23] = q_used[66]
    new_q_used[26] = q_used[65]
    new_q_used[28] = q_used[64]
    new_q_used[29] = q_used[63]
    new_q_used[69] = q_used[62]
    new_q_used[70] = q_used[61]
    new_q_used[30] = q_used[60]
    new_q_used[36] = q_used[59]
    new_q_used[39] = q_used[58]
    new_q_used[72] = q_used[57]
    new_q_used[31] = q_used[56]
    new_q_used[32] = q_used[55]
    new_q_used[71] = q_used[54]
    new_q_used[33] = q_used[53]
    new_q_used[38] = q_used[52]
    new_q_used[34] = q_used[51]
    new_q_used[35] = q_used[81]
    new_q_used[37] = q_used[80]
    new_q_used[40] = q_used[79]
    new_q_used[41] = q_used[78]
    new_q_used[42] = q_used[77]
    new_q_used[43] = q_used[76]
    new_q_used[44] = q_used[75]
    new_q_used[45] = q_used[74]
    new_q_used[46] = q_used[73]
    new_q_used[47] = q_used[50]
    new_q_used[48] = q_used[49]
    new_q_used[49] = q_used[48]
    new_q_used[50] = q_used[47]
    new_q_used[73] = q_used[46]
    new_q_used[74] = q_used[45]
    new_q_used[75] = q_used[44]
    new_q_used[76] = q_used[43]
    new_q_used[77] = q_used[42]
    new_q_used[78] = q_used[41]
    new_q_used[79] = q_used[40]
    new_q_used[80] = q_used[38]
    new_q_used[81] = q_used[37]
    new_q_used[51] = q_used[35]
    new_q_used[52] = q_used[34]
    new_q_used[53] = q_used[71]
    new_q_used[54] = q_used[33]
    new_q_used[55] = q_used[72]
    new_q_used[56] = q_used[32]
    new_q_used[57] = q_used[31]
    new_q_used[58] = q_used[70]
    new_q_used[59] = q_used[39]
    new_q_used[60] = q_used[36]
    new_q_used[61] = q_used[30]
    new_q_used[62] = q_used[69]
    new_q_used[63] = q_used[29]
    new_q_used[64] = q_used[28]
    new_q_used[65] = q_used[26]
    new_q_used[66] = q_used[23]
    new_q_used[67] = q_used[19]
    new_q_used[68] = q_zero[23]
    new_q_used[82] = q_zero[24]

    for bit in q:
        if bit not in new_q_used:
            new_q_zero.append(bit)

    CNOT | (q_used[70], q_used[69])
    CNOT | (q_used[73], q_used[68])
    CNOT | (q_used[77], q_used[63])
    CNOT | (q_used[70], q_used[62])
    CNOT | (q_used[69], q_used[61])
    CNOT | (q_used[70], q_used[60])
    CNOT | (q_used[66], q_used[57])
    CNOT | (q_used[69], q_used[55])
    CNOT2(eng, q_used[75], q_used[79], q_used[82])
    CNOT2(eng, q_used[53], q_used[56], q_used[81])
    CNOT2(eng, q_used[65], q_used[71], q_used[80])
    CNOT2(eng, q_used[58], q_used[73], q_used[79])
    CNOT2(eng, q_used[57], q_used[58], q_used[78])
    CNOT2(eng, q_used[56], q_used[64], q_used[77])
    CNOT2(eng, q_used[51], q_used[72], q_used[76])
    CNOT2(eng, q_used[67], q_used[74], q_used[75])
    CNOT2(eng, q_used[54], q_used[66], q_used[74])
    CNOT2(eng, q_used[59], q_used[63], q_used[73])
    CNOT2(eng, q_used[52], q_used[60], q_used[72])
    CNOT2(eng, q_used[51], q_used[53], q_used[71])
    CNOT2(eng, q_used[55], q_used[61], q_used[70])
    CNOT2(eng, q_used[66], q_used[67], q_used[69])
    CNOT | (q_used[46], q_used[81])
    CNOT | (q_used[50], q_used[80])
    CNOT | (q_used[47], q_used[79])
    CNOT | (q_used[42], q_used[78])
    CNOT | (q_used[43], q_used[77])
    CNOT | (q_used[48], q_used[76])
    CNOT | (q_used[44], q_used[75])
    CNOT | (q_used[45], q_used[74])
    CNOT | (q_used[49], q_used[73])
    CNOT | (q_used[29], q_used[72])
    CNOT | (q_used[32], q_used[71])
    CNOT | (q_used[9], q_used[70])
    CNOT | (q_used[15], q_used[69])
    Toffoli_gate(eng, q_used[81], q_used[1], q_used[68], resource_check)
    Toffoli_gate(eng, q_used[80], q_used[2], q_used[67], resource_check)
    Toffoli_gate(eng, q_used[79], q_used[0], q_used[66], resource_check)
    Toffoli_gate(eng, q_used[78], q_used[11], q_used[65], resource_check)
    Toffoli_gate(eng, q_used[77], q_used[4], q_used[64], resource_check)
    Toffoli_gate(eng, q_used[76], u1[7], q_used[63], resource_check)
    Toffoli_gate(eng, q_used[75], u1[4], q_used[62], resource_check)
    Toffoli_gate(eng, q_used[74], q_used[12], q_used[61], resource_check)
    Toffoli_gate(eng, q_used[73], q_used[8], q_used[60], resource_check)
    Toffoli_gate(eng, q_used[46], q_used[7], q_used[59], resource_check)
    Toffoli_gate(eng, q_used[50], u1[5], q_used[58], resource_check)
    Toffoli_gate(eng, q_used[47], u1[6], q_used[57], resource_check)
    Toffoli_gate(eng, q_used[42], q_used[10], q_used[56], resource_check)
    Toffoli_gate(eng, q_used[43], q_used[6], q_used[55], resource_check)
    Toffoli_gate(eng, q_used[48], u1[3], q_used[54], resource_check)
    Toffoli_gate(eng, q_used[44], u1[0], q_used[53], resource_check)
    Toffoli_gate(eng, q_used[45], q_used[5], q_used[52], resource_check)
    Toffoli_gate(eng, q_used[49], q_used[3], q_used[51], resource_check)
    CNOT | (q_used[46], q_used[81])
    CNOT | (q_used[50], q_used[80])
    CNOT | (q_used[47], q_used[79])
    CNOT | (q_used[42], q_used[78])
    ...
    CNOT | (q_used[45], q_used[74])
    CNOT | (q_used[49], q_used[73])
    CNOT2(eng, q_used[47], q_used[46], q_used[50])
    CNOT2(eng, q_used[44], q_used[45], q_used[49])
    CNOT2(eng, q_used[42], q_used[43], q_used[48])
    CNOT2(eng, q_used[42], q_used[44], q_used[47])
    CNOT2(eng, q_used[43], q_used[45], q_used[46])
    CNOT2(eng, q_used[40], q_used[41], q_used[45])
    CNOT2(eng, q_used[23], q_used[35], q_used[44])
    CNOT2(eng, q_used[37], q_used[38], q_used[43])
    CNOT2(eng, q_used[19], q_used[34], q_used[42])
    CNOT2(eng, q_used[29], q_used[30], q_used[41])
    Toffoli_gate(eng, q_used[72], q_used[39], q_used[40], resource_check)
    Toffoli_gate(eng, q_used[71], q_used[36], q_used[37], resource_check)
    Toffoli_gate(eng, q_used[31], q_used[29], q_used[35], resource_check)
    Toffoli_gate(eng, q_used[33], q_used[32], q_used[34], resource_check)
    CNOT2(eng, q_used[32], q_used[30], q_used[38])
    CNOT2(eng, q_used[23], q_used[30], q_used[33])
    CNOT | (q_used[32], q_used[71])
    CNOT2(eng, q_used[9], q_used[19], q_used[32])
    CNOT2(eng, q_used[19], q_used[30], q_used[31])
    CNOT | (q_used[29], q_used[72])
    Toffoli_gate(eng, q_used[19], q_used[69], q_used[39], resource_check)
    Toffoli_gate(eng, q_used[70], q_used[23], q_used[36], resource_check)
    Toffoli_gate(eng, q_used[15], q_used[9], q_used[30], resource_check)
    CNOT | (q_used[9], q_used[70])
    CNOT | (q_used[15], q_used[69])
    CNOT2(eng, q_used[15], q_used[23], q_used[29])
    CNOT | (q_used[14], q_used[23])
    CNOT | (q_used[26], q_used[15])
    CNOT | (q_used[28], q_used[19])
    CNOT | (q_used[26], q_used[9])
    CNOT | (q_used[28], q_used[23])
    CNOT | (q_used[21], q_used[15])
    CNOT | (q_used[13], q_used[19])
    CNOT | (q_used[17], q_used[9])
    CNOT2(eng, q_used[27], q_used[24], q_used[28])
    CNOT2(eng, q_used[25], q_used[24], q_used[26])
    CNOT2(eng, q_used[22], q_used[20], q_used[23])
    CNOT | (q_used[20], q_used[15])
    CNOT2(eng, q_used[18], q_used[16], q_used[19])
    CNOT | (q_used[16], q_used[9])
    Toffoli_gate(eng, q_used[1], q_used[7], q_used[27], resource_check)
    Toffoli_gate(eng, q_used[2], u1[5], q_used[25], resource_check)
    Toffoli_gate(eng, q_used[0], u1[6], q_used[24], resource_check)
    Toffoli_gate(eng, q_used[11], q_used[10], q_used[22], resource_check)
    Toffoli_gate(eng, q_used[4], q_used[6], q_used[21], resource_check)
    Toffoli_gate(eng, u1[7], u1[3], q_used[20], resource_check)
    Toffoli_gate(eng, u1[4], u1[0], q_used[18], resource_check)
    Toffoli_gate(eng, q_used[12], q_used[5], q_used[17], resource_check)
    Toffoli_gate(eng, q_used[8], q_used[3], q_used[16], resource_check)
    CNOT | (q_used[0], u1[5])
    ...
    Toffoli_gate(eng, new_q_used[12], new_q_used[5], new_q_used[17], resource_check)
    Toffoli_gate(eng, u2[4], u2[0], new_q_used[18], resource_check)
    Toffoli_gate(eng, u2[7], u2[3], new_q_used[20], resource_check)
    Toffoli_gate(eng, new_q_used[4], new_q_used[6], new_q_used[21], resource_check)
    Toffoli_gate(eng, new_q_used[11], new_q_used[10], new_q_used[22], resource_check)
    Toffoli_gate(eng, new_q_used[0], u2[6], new_q_used[24], resource_check)
    Toffoli_gate(eng, new_q_used[2], u2[5], new_q_used[25], resource_check)
    Toffoli_gate(eng, new_q_used[1], new_q_used[7], new_q_used[27], resource_check)
    CNOT | (new_q_used[16], new_q_used[9])
    CNOT2(eng, new_q_used[18], new_q_used[16], new_q_used[19])
    CNOT | (new_q_used[20], new_q_used[15])
    CNOT2(eng, new_q_used[22], new_q_used[20], new_q_used[23])
    CNOT2(eng, new_q_used[25], new_q_used[24], new_q_used[26])
    CNOT2(eng, new_q_used[27], new_q_used[24], new_q_used[28])
    CNOT | (new_q_used[17], new_q_used[9])
    CNOT | (new_q_used[13], new_q_used[19])
    CNOT | (new_q_used[21], new_q_used[15])
    CNOT | (new_q_used[28], new_q_used[23])
    CNOT | (new_q_used[26], new_q_used[9])
    CNOT | (new_q_used[28], new_q_used[19])
    CNOT | (new_q_used[26], new_q_used[15])
    CNOT | (new_q_used[14], new_q_used[23])
    CNOT2(eng, new_q_used[15], new_q_used[23], new_q_used[29])
    CNOT | (new_q_used[15], new_q_used[69])
    CNOT | (new_q_used[9], new_q_used[70])
    Toffoli_gate(eng, new_q_used[15], new_q_used[9], new_q_used[30], resource_check)
    Toffoli_gate(eng, new_q_used[70], new_q_used[23], new_q_used[36], resource_check)
    Toffoli_gate(eng, new_q_used[19], new_q_used[69], new_q_used[39], resource_check)
    CNOT | (new_q_used[29], new_q_used[72])
    CNOT2(eng, new_q_used[19], new_q_used[30], new_q_used[31])
    CNOT2(eng, new_q_used[9], new_q_used[19], new_q_used[32])
    CNOT | (new_q_used[32], new_q_used[71])
    CNOT2(eng, new_q_used[23], new_q_used[30], new_q_used[33])
    CNOT2(eng, new_q_used[32], new_q_used[30], new_q_used[38])
    Toffoli_gate(eng, new_q_used[33], new_q_used[32], new_q_used[34], resource_check)
    Toffoli_gate(eng, new_q_used[31], new_q_used[29], new_q_used[35], resource_check)
    Toffoli_gate(eng, new_q_used[71], new_q_used[36], new_q_used[37], resource_check)
    Toffoli_gate(eng, new_q_used[72], new_q_used[39], new_q_used[40], resource_check)
    CNOT2(eng, new_q_used[29], new_q_used[30], new_q_used[41])
    CNOT2(eng, new_q_used[19], new_q_used[34], new_q_used[42])
    CNOT2(eng, new_q_used[37], new_q_used[38], new_q_used[43])
    CNOT2(eng, new_q_used[23], new_q_used[35], new_q_used[44])
    CNOT2(eng, new_q_used[40], new_q_used[41], new_q_used[45])
    CNOT2(eng, new_q_used[43], new_q_used[45], new_q_used[46])
    CNOT2(eng, new_q_used[42], new_q_used[44], new_q_used[47])
    CNOT2(eng, new_q_used[42], new_q_used[43], new_q_used[48])
    CNOT2(eng, new_q_used[44], new_q_used[45], new_q_used[49])
    CNOT2(eng, new_q_used[47], new_q_used[46], new_q_used[50])
    CNOT | (new_q_used[49], new_q_used[73])
    CNOT | (new_q_used[45], new_q_used[74])
    CNOT | (new_q_used[44], new_q_used[75])
    CNOT | (new_q_used[48], new_q_used[76])
    CNOT | (new_q_used[43], new_q_used[77])
    CNOT | (new_q_used[42], new_q_used[78])
    CNOT | (new_q_used[47], new_q_used[79])
    CNOT | (new_q_used[50], new_q_used[80])
    CNOT | (new_q_used[46], new_q_used[81])
    Toffoli_gate(eng, new_q_used[49], new_q_used[3], new_q_used[51], resource_check)
    Toffoli_gate(eng, new_q_used[45], new_q_used[5], new_q_used[52], resource_check)
    Toffoli_gate(eng, new_q_used[44], u2[0], new_q_used[53], resource_check)
    Toffoli_gate(eng, new_q_used[48], u2[3], new_q_used[54], resource_check)
    Toffoli_gate(eng, new_q_used[43], new_q_used[6], new_q_used[55], resource_check)
    Toffoli_gate(eng, new_q_used[42], new_q_used[10], new_q_used[56], resource_check)
    Toffoli_gate(eng, new_q_used[47], u2[6], new_q_used[57], resource_check)
    Toffoli_gate(eng, new_q_used[50], u2[5], new_q_used[58], resource_check)
    Toffoli_gate(eng, new_q_used[46], new_q_used[7], new_q_used[59], resource_check)
    Toffoli_gate(eng, new_q_used[73], new_q_used[8], new_q_used[60], resource_check)
    Toffoli_gate(eng, new_q_used[74], new_q_used[12], new_q_used[61], resource_check)
    Toffoli_gate(eng, new_q_used[75], u2[4], new_q_used[62], resource_check)
    Toffoli_gate(eng, new_q_used[76], u2[7], new_q_used[63], resource_check)
    Toffoli_gate(eng, new_q_used[77], new_q_used[4], new_q_used[64], resource_check)
    Toffoli_gate(eng, new_q_used[78], new_q_used[11], new_q_used[65], resource_check)
    Toffoli_gate(eng, new_q_used[79], new_q_used[0], new_q_used[66], resource_check)
    Toffoli_gate(eng, new_q_used[80], new_q_used[2], new_q_used[67], resource_check)
    Toffoli_gate(eng, new_q_used[81], new_q_used[1], new_q_used[68], resource_check)
    CNOT | (new_q_used[15], new_q_used[69])
    CNOT | (new_q_used[9], new_q_used[70])
    CNOT | (new_q_used[32], new_q_used[71])
    CNOT | (new_q_used[29], new_q_used[72])
    ...
    CNOT | (new_q_used[50], new_q_used[80])
    CNOT | (new_q_used[46], new_q_used[81])
    CNOT2(eng, new_q_used[66], new_q_used[67], new_q_used[69])
    CNOT2(eng, new_q_used[55], new_q_used[61], new_q_used[70])
    CNOT2(eng, new_q_used[51], new_q_used[53], new_q_used[71])
    CNOT2(eng, new_q_used[52], new_q_used[60], new_q_used[72])
    CNOT2(eng, new_q_used[59], new_q_used[63], new_q_used[73])
    CNOT2(eng, new_q_used[54], new_q_used[66], new_q_used[74])
    CNOT2(eng, new_q_used[67], new_q_used[74], new_q_used[75])
    CNOT2(eng, new_q_used[51], new_q_used[72], new_q_used[76])
    CNOT2(eng, new_q_used[56], new_q_used[64], new_q_used[77])
    CNOT2(eng, new_q_used[57], new_q_used[58], new_q_used[78])
    CNOT2(eng, new_q_used[58], new_q_used[73], new_q_used[79])
    CNOT2(eng, new_q_used[65], new_q_used[71], new_q_used[80])
    CNOT2(eng, new_q_used[53], new_q_used[56], new_q_used[81])
    CNOT2(eng, new_q_used[75], new_q_used[79], new_q_used[82])
    CNOT | (new_q_used[69], new_q_used[55])
    CNOT | (new_q_used[66], new_q_used[57])
    CNOT | (new_q_used[70], new_q_used[60])
    CNOT | (new_q_used[69], new_q_used[61])
    CNOT | (new_q_used[70], new_q_used[62])
    CNOT | (new_q_used[77], new_q_used[63])
    CNOT | (new_q_used[73], new_q_used[68])
    CNOT | (new_q_used[70], new_q_used[69])
    CNOT2(eng, new_q_used[70], new_q_used[76], s2[4])
    CNOT2(eng, new_q_used[72], new_q_used[81], s2[3])
    CNOT2(eng, new_q_used[63], new_q_used[71], s2[0])
    CNOT2(eng, new_q_used[60], new_q_used[78], s2[7])
    CNOT2(eng, new_q_used[76], new_q_used[78], s2[6])
    CNOT2(eng, new_q_used[77], new_q_used[79], s2[1])
    CNOT2(eng, new_q_used[80], new_q_used[57], s2[5])
    CNOT2(eng, new_q_used[80], new_q_used[62], s2[2])
    CNOT | (new_q_used[75], s2[7])
    CNOT | (new_q_used[61], s2[6])
    CNOT | (new_q_used[68], s2[5])
    X | s2[6]
    X | s2[5]
    CNOT | (new_q_used[75], s2[4])
    CNOT | (new_q_used[69], s2[3])
    CNOT | (new_q_used[82], s2[2])
    CNOT | (new_q_used[55], s2[1])
    CNOT | (new_q_used[75], s2[0])
    X | s2[1]
    X | s2[0]
...
def round_combine(round, middle_mc, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
    ...
    if round % 2 == 1:
        for_key_xor_site = 0
        for_key_xor_bit = round // 2
        X | Key_inputs[for_key_xor_site][for_key_xor_bit]
...
def round_last_combine_noMC(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):

    prior_inputs = split_num(prior_input, 16)
    Sbox_inputs = split_num(input, 16)  # 16 Sboxes
    Sbox_outputs = split_num(output, 16)  # next round values
    Key_inputs = split_num(key, 16)
    Key_outputs = [Key_inputs[0], Key_inputs[1], Key_inputs[2], Key_inputs[3]]
    q_ancli_for_key_w3_values = split_num(q_ancli_for_key_w3, 4)
    prior_ancli_for_w3_values = split_num(prior_ancli_for_w3, 4)
    ...
    for site in range(4):
        for bit in range(8):
            CNOT | (Key_inputs[site+12][bit], q_ancli_for_key_w3_values[site][bit])
    ...
    for site in range(0, 16):
        for bit in range(8):
            CNOT | (Key_inputs[site][bit], Sbox_outputs[site][bit])
    #
    #
    output = combine16(Sbox_outputs)
...
#OUTPUT: 0C 93 7E A5   88 91 74 E2   E9 4A 7A D5   B4 CA E6 92
...
if __name__ == "__main__":
    key_qubits = eng.allocate_qureg(256)
    input_qibuts = eng.allocate_qureg(128)
    middle_mc_set = [0 for i in range(14)]
    for i in range(14):
    ...
    all_q_ancli_for_key_w3 = eng.allocate_qureg(32*14)
    ...
    round13_qubits = eng.allocate_qureg(128)
    round14_qubits = eng.allocate_qureg(128)



    # allqubits = [key_qubits, input_qibuts, round1_qubits, round2_qubits, round3_qubits, round4_qubits, round5_qubits, round6_qubits, round7_qubits, round8_qubits, round9_qubits, round10_qubits, round11_qubits, round12_qubits, round13_qubits, round14_qubits]
    allqubits = [round14_qubits]
    ...
    print("round 2")
    round_combine(2, middle_mc_set[1], round1_qubits, key_qubits, round2_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 1:32 * 1 + 32], input_qibuts, all_q_ancli_for_key_w3[0:32])
    print("round 3")
    round_combine(3, middle_mc_set[2], round2_qubits, key_qubits, round3_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32], round1_qubits, all_q_ancli_for_key_w3[32 * 1:32 * 1 + 32])
    print("round 4")
    round_combine(4, middle_mc_set[3], round3_qubits, key_qubits, round4_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32], round2_qubits, all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32])
    print("round 5")
    round_combine(5, middle_mc_set[4], round4_qubits, key_qubits, round5_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32], round3_qubits, all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32])
    print("round 6")
    round_combine(6, middle_mc_set[5], round5_qubits, key_qubits, round6_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 5:32 * 5 + 32], round4_qubits, all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32])
    print("round 7")
    round_combine(7, middle_mc_set[6], round6_qubits, key_qubits, round7_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 6:32 * 6 + 32], round5_qubits, all_q_ancli_for_key_w3[32 * 5:32 * 5 + 32])
    print("round 8")
    round_combine(8, middle_mc_set[7], round7_qubits, key_qubits, round8_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 7:32 * 7 + 32], round6_qubits, all_q_ancli_for_key_w3[32 * 6:32 * 6 + 32])
    print("round 9")
    round_combine(9, middle_mc_set[8], round8_qubits, key_qubits, round9_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 8:32 * 8 + 32], round7_qubits, all_q_ancli_for_key_w3[32 * 7:32 * 7 + 32])
    print("round 10")
    round_combine(10, middle_mc_set[9], round9_qubits, key_qubits, round10_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 9:32 * 9 + 32], round8_qubits, all_q_ancli_for_key_w3[32 * 8:32 * 8 + 32])
    print("round 11")
    round_combine(11, middle_mc_set[10], round10_qubits, key_qubits, round11_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 10:32 * 10 + 32], round9_qubits, all_q_ancli_for_key_w3[32 * 9:32 * 9 + 32])
    print("round 12")
    round_combine(12, middle_mc_set[11], round11_qubits, key_qubits, round12_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 11:32 * 11 + 32], round10_qubits, all_q_ancli_for_key_w3[32 * 10:32 * 10 + 32])
    print("round 13")
    round_combine(13, middle_mc_set[12], round12_qubits, key_qubits, round13_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 12:32 * 12 + 32], round11_qubits, all_q_ancli_for_key_w3[32 * 11:32 * 11 + 32])
    print("round 14")
    round_combine(14, middle_mc_set[13], round13_qubits, key_qubits, round14_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 13:32 * 13 + 32], round12_qubits, all_q_ancli_for_key_w3[32 * 12:32 * 12 + 32])
