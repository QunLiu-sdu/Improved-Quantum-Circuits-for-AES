...
def round1_nocombine(middle_mc, input, key, output, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3):
    ...
    for site in range(0, 16):
        for bit in range(8):
            CNOT | (Key_inputs[site][bit], mc_outputs[site][bit])
...
if __name__ == "__main__":
    ...
    middle_mc_set = [0 for i in range(10)]
    for i in range(10):
    ...
    print("round 1")
    all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero = round1_nocombine(middle_mc_set[0], input_qibuts, key_qubits, round1_qubits, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[0:32])

    print("round 2")
    round_combine(2, middle_mc_set[1], round1_qubits, key_qubits, round2_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 1:32 * 1 + 32], input_qibuts, all_q_ancli_for_key_w3[0:32])
    #
    print("round 3")
    round_combine(3, middle_mc_set[2], round2_qubits, key_qubits, round3_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32], round1_qubits, all_q_ancli_for_key_w3[32 * 1:32 * 1 + 32])

    print("round 4")
    round_combine(4, middle_mc_set[3], round3_qubits, key_qubits, round4_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32], round2_qubits, all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32])
    #
    print("round 5")
    round_combine(5, middle_mc_set[4], round4_qubits, key_qubits, round5_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32], round3_qubits, all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32])

    print("round 6")
    round_combine(6, middle_mc_set[5], round5_qubits, key_qubits, round6_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 5:32 * 5 + 32], round4_qubits, all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32])

    print("round 7")
    round_combine(7, middle_mc_set[6], round6_qubits, key_qubits, round7_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 6:32 * 6 + 32], round5_qubits, all_q_ancli_for_key_w3[32 * 5:32 * 5 + 32])

    print("round 8")
    round_combine(8, middle_mc_set[7], round7_qubits, key_qubits, round8_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 7:32 * 7 + 32], round6_qubits, all_q_ancli_for_key_w3[32 * 6:32 * 6 + 32])

    print("round 9")
    round_combine(9, middle_mc_set[8], round8_qubits, key_qubits, round9_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit, all_q_ancli_for_key_w3[32 * 8:32 * 8 + 32], round7_qubits, all_q_ancli_for_key_w3[32 * 7:32 * 7 + 32])
