...
def round1_nocombine(input, key, output, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3):
...
def round_combine(round, input, key, output, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero, q_inputs, q_keys, tem_shift_qubit, q_ancli_for_key_w3, prior_input, prior_ancli_for_w3):
...
if __name__ == "__main__":
    ...
    print("round 1")
    all_q_inputs_used, all_q_inputs_zero, all_q_keys_used, all_q_keys_zero = round1_nocombine(input_qibuts, key_qubits,
                                                                                              round1_qubits, allqbits_block,
                                                                                              allqbits_key, tem_shift_qubit,
                                                                                              all_q_ancli_for_key_w3[0:32])
    print("round 2")
    round_combine(2, round1_qubits, key_qubits, round2_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
    ...
    print("round 3")
    round_combine(3, round2_qubits, key_qubits, round3_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32], round1_qubits, all_q_ancli_for_key_w3[32 * 1:32 * 1 + 32])
    print("round 4")
    round_combine(4, round3_qubits, key_qubits, round4_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32], round2_qubits, all_q_ancli_for_key_w3[32 * 2:32 * 2 + 32])
    print("round 5")
    round_combine(5, round4_qubits, key_qubits, round5_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32], round3_qubits, all_q_ancli_for_key_w3[32 * 3:32 * 3 + 32])
    print("round 6")
    round_combine(6, round5_qubits, key_qubits, round6_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 5:32 * 5 + 32], round4_qubits, all_q_ancli_for_key_w3[32 * 4:32 * 4 + 32])
    print("round 7")
    round_combine(7, round6_qubits, key_qubits, round7_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 6:32 * 6 + 32], round5_qubits, all_q_ancli_for_key_w3[32 * 5:32 * 5 + 32])
    print("round 8")
    round_combine(8, round7_qubits, key_qubits, round8_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 7:32 * 7 + 32], round6_qubits, all_q_ancli_for_key_w3[32 * 6:32 * 6 + 32])
    print("round 9")
    round_combine(9, round8_qubits, key_qubits, round9_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 8:32 * 8 + 32], round7_qubits, all_q_ancli_for_key_w3[32 * 7:32 * 7 + 32])
    print("round 10")
    round_combine(10, round9_qubits, key_qubits, round10_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 9:32 * 9 + 32], round8_qubits, all_q_ancli_for_key_w3[32 * 8:32 * 8 + 32])
    print("round 11")
    round_combine(11, round10_qubits, key_qubits, round11_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 10:32 * 10 + 32], round9_qubits, all_q_ancli_for_key_w3[32 * 9:32 * 9 + 32])
    print("round 12")
    round_combine(12, round11_qubits, key_qubits, round12_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 11:32 * 11 + 32], round10_qubits, all_q_ancli_for_key_w3[32 * 10:32 * 10 + 32])
    print("round 13")
    round_combine(13, round12_qubits, key_qubits, round13_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
                  all_q_ancli_for_key_w3[32 * 12:32 * 12 + 32], round11_qubits, all_q_ancli_for_key_w3[32 * 11:32 * 11 + 32])
    print("round 14")
    round_combine(14, round13_qubits, key_qubits, round14_qubits, all_q_inputs_used, all_q_inputs_zero, all_q_keys_used,
                  all_q_keys_zero, allqbits_block, allqbits_key, tem_shift_qubit,
